...
<body>
        ...
        <div class="csslider infinity" id="slider1">
            ...
            <ul class="banner banner1">
                <li class="banner-top1">
                    <div class="container">
                        <div class="banner-info_w3ls">
                            <h3 class="text-wh font-weight-bold mt-2 mb-5 banner-title">Technology Based Logistics Solution
                            </h3>
                ...
                <li class="banner banner2">
                    <div class="container">
                        <div class="banner-info_w3ls">
                            <h3 class="text-wh font-weight-bold mt-2 mb-5 banner-title"
                                style="background-color: rgba(0, 0, 0, 0.55); !important">Inventory Management</h3>
            ...
            <div class="row bg-colors text-center">
                <div class="col-md-4 service-subgrids">
                    <div class="w3ls-about-grid py-lg-5 py-md-4 py-5 px-3">
                        ...
                        <p class="text-li">Customized Warehouse & Inventory Management with Solution Based & Cost Effective
                            Approach.</p>
                    </div>
                ...
                <div class="col-md-4 service-subgrids bg-li">
                    <div class="w3ls-about-grid py-lg-5 py-md-4 py-5 px-3">
                        ...
                        <p class="text-secondary">System Integrated & Technology Driven Services, IOT Product Solution ,
                            Process Improvement & Consulting of Services.</p>
                    </div>
                ...
                <div class="col-md-4 service-subgrids">
                    <div class="w3ls-about-grid py-lg-5 py-md-4 py-5 px-3">
                        ...
                        <p class="text-li"> Rapidly Growing with Digitised Forwarding Services, Turn Key Projects at all major
                            Indian Ports.</p>
                    </div>
            ...
            <div class="row bg-colors text-center">
                <div class="col-md-4 service-subgrids bg-li">
                    <div class="w3ls-about-grid py-lg-5 py-md-4 py-5 px-3">
                        ...
                        <p class="text-secondary"> Customized Documentation, Kitting, Stickering, GST/Excise Registration and
                            other various value added services.</p>
                    </div>
                ...
                <div class="col-md-4 service-subgrids">
                    <div class="w3ls-about-grid py-lg-5 py-md-4 py-5 px-3">
                        ...
                        <p class="text-li"> Emerging Player with one of the most important aspect of Logistics or materials
                            handling system, right along with system design and performance.</p>
                    </div>
                ...
                <div class="col-md-4 service-subgrids bg-li">
                    <div class="w3ls-about-grid py-lg-5 py-md-4 py-5 px-3">
                        ...
                        <p class="text-secondary">Primary & Secondary Distribution of Goods, Cross Border Deliveries up to Last
                            Mile with On Time Performance.</p>
                    </div>
    ...
    <div class="container introduction">
        ...
        <p class="text-center text-secondary">At <strong>GRAM Supply Chain Solutions Private Limited</strong>, we pride
            ourselves on being a leading integrated logistics solution provider in India, with a strong presence in
            international markets such as Japan. Our rapid expansion is driven by our commitment to leveraging
            cutting-edge technology and scientific methods to minimize human intervention and maximize efficiency. We
            are dedicated to delivering innovative logistics solutions that streamline operations and enhance supply
            chain performance.</p>
    </div>
            ...
            <div class="row no-gutters">
                <div class="col-6 who-left-w3pvt">
                    ...
                    <p style="font-size: 1.2rem;" class="mb-5 text-secondary">At GRAM SCS, we prioritize customer
                        satisfaction by offering state-of-the-art logistics services. Our team utilizes the latest
                        technological advancements to ensure that we meet and exceed our clients' expectations, fostering
                        strong and enduring partnerships.</p>
                ...
                <div class="col-6 mt-xl-0 text-xl-right text-center" id="warehouse-image-container">
                    <img class="img-fluid rounded" src="images/warehouse.jpg" alt="" width="90%"
                        style="height: 80vh; border: 5px double black;">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="mission">
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <img class="img-fluid rounded" src="images/warehouse2.jpg" alt="" width="90%"
                        style="height: 80vh; border: 5px double black;">
                </div>
                <div class="col-6 text-align-justify">
                    <p style="font-size: 1.2rem;" class="ml-4 text-secondary">GRAM SCS fully believes in give & take
                        principle. The more we take care of our employees, the better we get at managing their work.
                        Hence at GRAM, employees are given equal growth opportunities irrespective of color, gender,
                        religion etc.</p>
                </div>
            </div>
        </div>
    ...
    <div class="gallery py-5" id="gallery" style="margin-top: 100px; margin-bottom: 100px;">
        ...
        <div id="gal1" class="pop-overlay animate">
            <div class="popup">
                ...
                <p class="mt-4 text-secondary">Efficient and seamless international shipping services at a bustling
                    port, ensuring timely and secure delivery of your cargo.</p>
        ...
        <div id="gal2" class="pop-overlay animate">
            <div class="popup">
                ...
                <p class="mt-4 text-secondary text-secondary">Our fleet of cargo trucks on the move, dedicated to
                    providing reliable and efficient ground transportation for your goods.</p>
                <a class="close" href="#gallery">&times;</a>
            </div>
        </div>
        <!-- popup-->
        <div id="gal3" class="pop-overlay animate">
            <div class="popup">
                ...
                <p class="mt-4 text-secondary">Well-maintained fleet of delivery trucks ready to distribute your
                    products nationwide with precision and care.</p>
                <a class="close" href="#gallery">&times;</a>
            </div>
        </div>
        <!-- popup-->
        <div id="gal4" class="pop-overlay animate">
            <div class="popup">
                ...
                <p class="mt-4 text-secondary">Experienced and dependable transportation services using traditional
                    cargo trucks for all your logistical needs.</p>
                <a class="close" href="#gallery">&times;</a>
            </div>
        </div>
        <!-- popup-->
        <div id="gal5" class="pop-overlay animate">
            <div class="popup">
                ...
                <p class="mt-4 text-secondary">Coordinated and high-volume container truck operations at the port,
                    ensuring quick and organized handling of your shipments.</p>
                <a class="close" href="#gallery">&times;</a>
            </div>
        </div>
        <!-- popup-->
        <div id="gal6" class="pop-overlay animate">
            <div class="popup">
                ...
                <p class="mt-4 text-secondary">Comprehensive maritime transport solutions, featuring a cargo ship
                    navigating through waterways to deliver your containers globally.</p>
                <a class="close" href="#gallery">&times;</a>
            </div>
        </div>
    </div>
            ...
            <div class="row mx-sm-0 mx-2">
                ...
                <div class="col-5 map" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3505.044411352865!2d77.2127728142571!3d28.53838479508832!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce398194e6799%3A0x40f2c7b780d291c!2sGRAM%20SCS%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1591499543546!5m2!1sen!2sin"
                        frameborder="0" style="border: 0; height:400px" allowfullscreen="" aria-hidden="false"
                        tabindex="0"></iframe>
                </div>
                <!-- contact form -->
                <div class="col-1"></div>
                <div class="col-4 main_grid_contact" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                    data-aos-duration="2000" style="border: 2px solid lightgrey; border-radius: 5%;">
