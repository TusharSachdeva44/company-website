    ...
    <div class="csslider infinity" id="slider1">
        ...
        <ul class="banner banner1">
            ...
            <li class="banner banner2">
                <div class="container">
                    <div class="banner-info_w3ls">
                        <h3 class="text-wh font-weight-bold mt-2 mb-5 banner-title bg-dark55">Inventory Management</h3>
...
<section class="w3ls-bnrbtm" id="who">
    <div class="container-fluid py-xl-5 py-lg-3 pl-40">
        <div class="row no-gutters">
            ...
            <div class="col-xl-6 mt-xl-0 mt-5 text-xl-right text-center">
                <img class="img-fluid rounded who-img" src="images/warehouse.jpg" alt="" width="90%">
            </div>
        </div>
    </div>
</section>
...
<!-- GALLERY SECTION -->
<div class="gallery py-5 gallery-spacing" id="gallery">
    ...
    <div class="container-fluid pb-3">
        ...
        <div class="row mx-sm-0 mx-2">
            ...
            <div class="col-5 map" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3505.044411352865!2d77.2127728142571!3d28.53838479508832!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce398194e6799%3A0x40f2c7b780d291c!2sGRAM%20SCS%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1591499543546!5m2!1sen!2sin" frameborder="0" class="map-iframe" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
            <div class="col-1"></div>
            <div class="col-4 main_grid_contact contact-form-border" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
...
<script type="text/javascript">
    (function () {
        var options = {
            whatsapp: "+91-9999470620",
            email: "support@gramscs.com",
            sms: "+91-9999470620",
            call: "+91-9999470620",
