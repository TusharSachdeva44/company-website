...
<img src="images/Ocean-Freight.jpg" width="100%">
<div class="container py-xl-1 py-lg-1">
			<div class="row">
				<div class="col-lg-12 pl-xl-1 mt-lg-0 mt-1">
<h3 style="padding:10px 0px;">Ocean Freight</h3>
<p style="padding-bottom:10px;">With no restrictions in the size and weight of the cargo, we provide a full array of ocean freight forwarding services right from door to door pick up, advance tracking technology and managing shipping documents.</p>

<p style="padding-bottom:10px;">Our experienced associates are trained to guide you through the complexities of international shipping. We offer tailored programs to meet our clients' full container load (FCL) and less than container load (LCL) requirements and transportation cost objectives.</p>
<p style="padding-bottom:10px;">Our services include flexible shipment tracking, purchase order management and space protection during periods of high demand..</p>
				</div>
	</div>
	  </div>
	</section>
