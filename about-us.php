...
<h2 style="padding-bottom:10px;">Our Story</h2>
<h5 style="padding-bottom:10px;"><em>How we incepted ? 2017</em></h5>
<p style="padding-bottom:10px;">GRAM Supply Chain Solutions started with an idea of providing automated & technology 
driven Logistics Services in the Indian Supply Chain Market with less human intervention 
& more technology based solutions.</p>
<h5 style="padding-bottom:10px;"><em>Up scaled Growth over the Years 2019</em></h5>
<p style="padding-bottom:10px;">GRAM expanded its business portfolio with over 15 International clients serving them at 
all India Locations.</p>
<h5 style="padding-bottom:10px;"><em>VISION</em></h5>
<p>To emerge as a leading Technology Driven Service Partner & Solution Provider 
in Indian Logistics Segment.</p>
				</div>
			</div>
		</div>
	</section>
